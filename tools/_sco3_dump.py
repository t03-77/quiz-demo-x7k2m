# -*- coding: utf-8 -*-
"""書き換え候補の問題を丸ごと出力する。
使い方: python tools/_sco3_dump.py SCS-C03 id1 id2 ...
        python tools/_sco3_dump.py SCS-C03 --list        候補一覧
"""
import sys, os
...
if args and args[0] == "--list":
    ...
    for q in L.load_mine():
        if q.get("type", "choice") != "choice" or not q.get("options"):
            continue
        p = L.pairs(q)
        ...
        rows.append((q["id"], ("RO:" if q.get("_ro") else "") + q["_file"].replace(EX + "_orig", ""), len(tw), p[0][0],
