...
使い方: python tools/_saao3_try.py 資料/生成/_saao3_patch_b1.json [...]"""
import json, sys, copy, statistics
from pathlib import Path
sys.path.insert(0, str(Path(__file__).resolve().parent))
from _saao3_lib import load_mine, load_off, pairs, overlap, multi_sent, maxsim, sentences
...
O = metrics(load_off())
print()
print("%-16s %8s %8s %8s"%("指標","before","after","SAA公式"))
