...
def main():
    ...
    ng_exam = []
    # 2026-09-09: 「重なりが薄い問題」と「転換表現あり」も資格別に出すようにした。
    # 全体の★としては残っていたのに資格別の内訳が無く、どの資格を直せばいいか
    # 分からない状態だった（鉄則5「資格をまたいで基準を作らない」）
    for title, fn, key in [("2. 選択肢の文法", option_stats, "2文以上"),
                           ("3. 選択肢どうしの関係", overlap_stats, "肢どうしの語の重なり"),
                           ("3. 選択肢どうしの関係", overlap_stats, "重なりが薄い問題(<0.1)"),
                           ("5. 解説の組み立て", expl_stats, "転換表現あり")]:
        print()
