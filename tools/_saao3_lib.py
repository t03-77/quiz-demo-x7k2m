# -*- coding: utf-8 -*-
"""SAA-C03 の O-3(正解と酷似した誤答)是正 用の共通ライブラリ。
測り方は audit_criteria.py の c2-3 / _nm4_check.py と同じ SequenceMatcher。
公式比較は必ず SAA-C03 の公式問題とだけ行う(鉄則5: 資格をまたいで基準を作らない)。"""
...
GEN = BASE / "資料" / "生成"
FILES = ["SAA-C03_orig.json", "SAA-C03_orig_b2.json", "SAA-C03_orig_b3.json",
         "SAA-C03_orig_b4.json", "SAA-C03_orig_gap1.json", "SAA-C03_orig_s9.json"]
...
if __name__ == "__main__":
    report(load_off(), "SAA 公式")
    report(load_mine(), "SAA 自作")
